...
// Method Definition Index: 11632
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Queue_1_TryDequeue_m7D88D036EDAFD540681FEE55AD7FA717267FA9D5_gshared (Queue_1_t9047E409B3024C6C77A6EA9F70254940517E77A6* __this, Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC* ___0_result, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	GoalU5BU5D_t571746C60172C172510EB4892D21335E21A43AB6* V_1 = NULL;
	Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC V_2;
	...
	{
		Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC* L_3 = ___0_result;
		il2cpp_codegen_initobj(L_3, sizeof(Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC));
		return (bool)0;
	}

IL_001f:
	{
		Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC* L_4 = ___0_result;
		GoalU5BU5D_t571746C60172C172510EB4892D21335E21A43AB6* L_5 = V_1;
		int32_t L_6 = V_0;
		NullCheck(L_5);
		int32_t L_7 = L_6;
		Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC L_8 = (L_5)->GetAt(static_cast<il2cpp_array_size_t>(L_7));
		*(Goal_t5B37A06267C447BA491BFE3C7066E4CD76B90ACC*)L_4 = L_8;
		goto IL_0043;
	}
...
IL_0043:
	{
		int32_t* L_9 = (int32_t*)(&__this->____head);
		Queue_1_MoveNext_m8E62FEB56E9BB6E3CB1FA803C14C908AA548D495(__this, L_9, il2cpp_rgctx_method(method->klass->rgctx_data, 7));
		int32_t L_10 = __this->____size;
		__this->____size = ((int32_t)il2cpp_codegen_subtract(L_10, 1));
		int32_t L_11 = __this->____version;
		__this->____version = ((int32_t)il2cpp_codegen_add(L_11, 1));
